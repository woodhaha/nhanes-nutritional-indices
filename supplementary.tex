...
\begin{center}
\textbf{Tables S1--S8, Figures S1--S3}

\vskip 0.3cm
\noindent{\footnotesize Supplementary Figures S1--S3 are provided as separate files (fig\_s1\_cally\_km.pdf, fig\_s2\_joint\_pni\_nlr.pdf, fig\_s3\_rmst.pdf).}
\end{center}
\vskip 0.5cm
...
RERI = $-$0.97 (95\% CI $-$2.61 to $-$0.10). The wide confidence interval (spanning 2.5 units) limits precision of this estimate, precluding strong conclusions about interaction on the additive scale.
...
\begin{tabular}{lcc}
\toprule
Variable & NHANES III (1988--1994, n=126) & Continuous NHANES (2005--2016, n=227) \\
\midrule
Age, years & 67.5 (13.9) & 57.5 (19.0) \\
Female (\%) & 43.1 & 59.7 \\
Non-Hispanic White (\%) & 68.4 & 32.6 \\
BMI, kg/m$^2$ & 29.3 (6.1) & 27.7 (6.5) \\
Albumin, g/dL & 4.12 (0.36) & 4.06 (0.41) \\
PNI & 50.7 (6.5) & 51.7 (6.0) \\
CONUT & 1.28 (1.27) & 0.69 (1.25) \\
GNRI & 116.8 (11.7) & 113.0 (12.3) \\
Site distribution (\%) & & \\
...
Deaths (\%) & 78.6 & 48.0 \\
Median survival, yr & 19.1 [7.0--26.8] & 7.1 [4.3--10.8] \\
Early death ($<$2 yr, \%) & 11.7 & 5.5 \\
\bottomrule
\end{tabular}
\end{center}
...
\subsection*{Figure S1: CALLY Index Kaplan--Meier}
CALLY = albumin $\times$ lymphocyte / CRP. Patients were stratified by the median CALLY value. The difference was not statistically significant (log-rank p=0.200), consistent with the CALLY Cox regression results (Table~S7c). n=250.

\subsection*{Figure S2: Joint PNI $\times$ NLR Kaplan--Meier}
Patients were stratified into four groups by PNI (above/below median) and NLR (above/below median). The Low PNI + High NLR group showed the lowest survival (log-rank p=0.028). n=258.

\subsection*{Figure S3: Restricted Mean Survival Time (PNI Threshold 48.5)}
Restricted mean survival at 10 years comparing PNI $\ge$48.5 vs. $<$48.5. The RMST difference was 1.97 years (95\% CI 1.19--2.76, p$<$0.001), favoring the high PNI group. n=353.
